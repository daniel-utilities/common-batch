...
set "str=0123456789"
echo BEFORE: "%str%"
echo :trim_front str "0189"
call :trim_front str "0189"
echo AFTER:  "%str%"
echo.
set "str=0123456789"
echo BEFORE: "%str%"
echo :trim_back str "0189"
call :trim_back str "0189"
echo AFTER:  "%str%"
echo.
set "str=0123456789"
echo BEFORE: "%str%"
...
set "str=0123456789"
echo BEFORE: "%str%"
echo :trim_front str "0123456789"
call :trim_front str "0123456789"
echo AFTER:  "%str%"
echo.
set "str=0123456789"
echo BEFORE: "%str%"
echo :trim_back str "0123456789"
call :trim_back str "0123456789"
echo AFTER:  "%str%"
echo.
set "str=0123456789"
echo BEFORE: "%str%"
echo :trim str "0123456789"
call :trim str "0123456789"
echo AFTER:  "%str%"
echo.
